...
import 'package:dart_neural_network/bin/dart_neural_network.dart';

Matrix2d m2d = Matrix2d();

List genList(List shape) {
  var twoDList = List<List>.generate(shape.shape[0],
      (i) => List<double>.generate(shape.shape[1], (j) => 0, growable: false));
  print(twoDList);
  return twoDList;
}
